    ...
    >
      <div className="flex items-center gap-[2rem] mb-[3.4rem]">
        ...
        <div>
          ...
          <a href={user?.html_url} className="text-[1.3rem] text-[#0079ff]">
            @{user?.login}
          </a>
          <p
      ...
      >
        <div>
          ...
          <p className="text-[1.6rem] font-bold">{user?.public_repos}</p>
        </div>
        ...
        <div>
          ...
          <p className="text-[1.6rem] font-bold">{user?.followers}</p>
        </div>
        ...
        <div>
          ...
          <p className="text-[1.6rem] font-bold">{user?.following}</p>
        </div>
      </div>
      ...
      <div>
        ...
        >
          <svg
            ...
            width="20"
            xmlns="http://www.w3.org/2000/svg"
            fill={user?.twitter_username ? (dark ? "white" : "blue") : "gray"}
          >
