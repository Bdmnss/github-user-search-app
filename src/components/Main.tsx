  ...
  return (
    <div className="bg-[#1e2a47] pt-[3.2rem] px-[2.4rem] pb-[4.8rem] rounded-[1.5rem]">
      <div className="flex items-center gap-[2rem] mb-[3.4rem]">
        ...
        <div>
          {user?.name ? (
            <p className="text-[1.6rem] text-white font-bold">{user?.name}</p>
          ) : (
      ...
      {user?.bio && (
        <p className="text-[1.3rem] text-white mb-[2.2rem]">{user?.bio}</p>
      )}
      ...
      <div>
        <div className="flex items-center text-white gap-[1.9rem] mb-[1.6rem]">
          <svg
            ...
            fill={user?.location ? "#fff" : "#ffffff53"}
          >
          ...
          {user?.location ? (
            ...
            <p className="text-[1.3rem] text-[#ffffff53]">Not Available</p>
          )}
        </div>
        ...
        <div className="flex items-center text-white gap-[1.3rem] mb-[1.6rem]">
          <svg
            ...
            width="20"
            xmlns="http://www.w3.org/2000/svg"
            fill={user?.twitter_username ? "#fff" : "#ffffff53"}
          >
        ...
        <div className="flex items-center text-white gap-[1.3rem]">
          <svg
            ...
            width="20"
            xmlns="http://www.w3.org/2000/svg"
            fill={user?.company ? "#fff" : "#ffffff53"}
          >
            <g>
